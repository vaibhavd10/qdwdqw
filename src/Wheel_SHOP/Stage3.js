      ...
      <ScrollView>
        ...
        <View style={styles.stage}>
          ...
          <View style={styles.stageform}>
            ...
            <View style={styles.headerTag}>
              <Text style={styles.text}>Wheel No.</Text>
            </View>
            <View style={styles.dateshift}>
              <View style={styles.dateshiftinside}>
                <Text style={{color: 'black'}}>Left</Text>
                <TextInput style={styles.input} value={input3} 
              ...
              <View style={styles.dateshiftinside}>
                ...
                <TextInput style={styles.input} value={input4} 
            ...
            <View style={styles.headerTag}>
              <Text style={styles.text}>Wheel Fitment pressure</Text>
            </View>
            <View style={styles.dateshift}>
              <View style={styles.dateshiftinside}>
                <Text style={{color: 'black'}}>Left</Text>
                <TextInput style={styles.input} value={input5} 
              ...
              <View style={styles.dateshiftinside}>
                <Text style={{color: 'black'}}>Right</Text>
                <TextInput style={styles.input} value={input6} 
            ...
            <View style={styles.headerTag}>
              <Text style={styles.text}>Disc No.</Text>
            </View>
            <View style={styles.dateshift}>
              <View style={styles.dateshiftinside}>
                <Text style={{color: 'black'}}>Left</Text>
                <TextInput style={styles.input} value={input7} 
              ...
              <View style={styles.dateshiftinside}>
                <Text style={{color: 'black'}}>Right</Text>
                <TextInput style={styles.input} value={input8} 
            ...
            <View style={styles.headerTag}>
              <Text style={styles.text}>
                Disk Fitment Pres. Make K / FV/PFL2
              </Text>
            </View>
            <View style={styles.dateshift}>
              <View style={styles.dateshiftinside}>
                <Text style={{color: 'black'}}>Left</Text>
                <TextInput style={styles.input} value={input9} 
              ...
              <View style={styles.dateshiftinside}>
                <Text style={{color: 'black'}}>Right</Text>
                <TextInput style={styles.input} value={input10} 
            ...
            <View style={styles.headerTag}>
              <Text style={styles.text}>Wheel Treed Dia. 915+4 to 0</Text>
            </View>

            <View style={styles.dateshift}>
              <View style={styles.dateshiftinside}>
                <Text style={{color: 'black'}}>Left</Text>
                <TextInput style={styles.input} value={input11} 
                onChangeText={setinput11}
              ...
              <View style={styles.dateshiftinside}>
                <Text style={{color: 'black'}}>Right</Text>
                <TextInput style={styles.input} value={input12} 
