...
export default function TabC({navigation, route}) {
    ...
    async function handleApproveA() {
      const providers2 = await axios
        ...
        .then(function (response) {
          alert('Job has been assigned to rework');
        })
      ...
      <View>
        {shop === 'BOGIE' ? (
          <><View style={styles.container}>
            {m5008.TEST_PASSED === false && jobcondition1 === true ? (
              <View style={{ flexDirection: 'column' }}>
                ...
                <TouchableOpacity
                onPress={handleApproveA}
                style={[styles.button1,{marginTop:10}]}>
                  <Text style={{color:"white"}}>Send to Rework</Text>
                </TouchableOpacity>
              </View>
            ) : null}
          </View><View style={styles.container}>
              {mainform.TEST_PASSED === false && jobcondition2 === true ? (
                <View style={{ flexDirection: 'column' }}>
              ...
              {m5017.TEST_PASSED === false && jobcondition3 === true ? (
                <View style={{ flexDirection: 'column' }}>
              ...
              {m5023.TEST_PASSED === false && jobcondition4 === true ? (
                <View style={{ flexDirection: 'column' }}>
            ...
            {stage1.TEST_PASSED === false && jobcondition1 === true ? (
              <View style={{ flexDirection: 'column' }}>
                <TouchableOpacity 
                onPress={createPDFstage1}>
                  <Text style={[styles.text,{paddingTop:5}]}>Stage 1</Text>
                  <Text>Download Report</Text>
                </TouchableOpacity>
                <TouchableOpacity
                onPress={handleApproveA}
              ...
              {stage2.TEST_PASSED === false && jobcondition2 === true ? (
                <View style={{ flexDirection: 'column' }}>
                  <TouchableOpacity
              ...
              {stage3.TEST_PASSED === false && jobcondition3 === true ? (
                <View style={{ flexDirection: 'column' }}>
                  <TouchableOpacity
              ...
              {stage4n5.TEST_PASSED === false && jobcondition4 === true ? (
                <View style={{ flexDirection: 'column' }}>
                  <TouchableOpacity
              ...
              {stage6.TEST_PASSED === false && jobcondition5 === true ? (
                <View style={{ flexDirection: 'column' }}>
                  <TouchableOpacity
