...
import axios from 'axios';
  ...
  const LwlrrmKNAsp1 = ({navigation,route}) => {
            ...
            <View style={{padding: 10}}>
              ...
              <View style={styles.boxstyle1}>
                ...
                <View
                  ...
                  <Text style={styles.text11}>LWLRRM(Gen.van)Side 1 Hand brake (120 KN AIR SPRING)</Text>
                  <TextInput
                    style={styles.input}
              ...
              <View style={styles.boxstyle1}>
                ...
                <Text style={styles.text2}>MCF/RBL/QMF-5024</Text>
              </View>
              <View style={styles.boxstyle1}>
              ...
              <View style={styles.boxstyle2}>
                <View style={{width: '50%', height: 350, padding: 5}}>
                  ...
                  <View style={{flex: 0.8}}>
                    <Text style={styles.textBox}>TARE 22.24</Text>
                  </View>
                  <View style={{flex: 0.8}}>
                    <Text style={styles.textBox}>GROSS 27.26</Text>
                  </View>
                </View>
