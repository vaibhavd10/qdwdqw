          ...
          <View style={{padding: 10}}>
            ...
            <View style={styles.boxstyle1}>
              ...
              <View
                ...
                <Text style={styles.text11}>LWACCN</Text>
                <TextInput
                  style={styles.input}
            ...
            <View style={styles.boxstyle1}>
              ...
              <Text style={styles.text2}>MCF/RBL/QMF-5009</Text>
            </View>
            <View style={styles.boxstyle1}>
              <Text style={styles.text2}>VERSION</Text>
              <Text style={styles.text2}>09/2021</Text>
            </View>
            <View style={styles.boxstyle1}>
            ...
            <View style={styles.boxstyle3}>
              <View style={{flexDirection: 'row'}}>
                <View style={{width: '50%', height: 350, padding: 5}}>
                  ...
                  <View style={{flex: 0.8}}>
                    <Text style={styles.textBox}>TARE 16.13</Text>
                  </View>
                  <View style={{flex: 0.8}}>
                    <Text style={styles.textBox}>GROSS 19.01</Text>
                  </View>
                </View>
            ...
            <View style={styles.boxstyle3}>
              <View style={{flexDirection: 'row'}}>
                ...
                <View style={{width: '50%', height: 350}}>
                  <View style={{flex: 2}}>
                    <Text style={styles.textBox}>
                      AVERAGE HEIGHT FROM TOP PLATE OF SIDE FRAME TO UPPER FACE
                      OF SPRING SEAT 44 +/- 3 MM TARE
                    </Text>
                  </View>
                  <View
                    style={{
