        ...
        <View>
          ...
          <View style={{padding: 10}}>
            ...
            <View style={styles.boxstyle1}>
              ...
              <View
                ...
                <Text style={styles.text11}>
                  AC-2T/EOG WITH (120KN AIR SPRING)
                </Text>
                <TextInput
                  style={styles.input}
            ...
            <View style={styles.boxstyle1}>
              ...
              <Text style={styles.text2}>MCF/RBL/QMF-5016</Text>
            </View>
            <View style={styles.boxstyle1}>
              <Text style={styles.text2}>VERSION</Text>
              <Text style={styles.text2}>07/2019</Text>
            </View>
            <View style={styles.boxstyle1}>
            ...
            <View style={styles.boxstyle3}>
              <View style={{flexDirection: 'row'}}>
                <View style={{width: '50%', height: 350, padding: 5}}>
                  ...
                  <View style={{flex: 1}}>
                    <Text style={styles.textBox}>TARE 16.02</Text>
                  </View>
                  <View style={{flex: 1}}>
                    <Text style={styles.textBox}>GROSS 18.90</Text>
                  </View>
                </View>
            ...
            <View style={styles.boxstyle3}>
              <View style={{flexDirection: 'row'}}>
                <View style={{width: '50%', height: 450, padding: 5}}>
                  <View style={{flex: 4}}>
                    <Text style={styles.textBox}>
                      TESTING LOAD {'\n'}
                      IN TONNES
                ...
                <View style={{width: '50%', height: 450}}>
                  <View style={{flex: 3}}>
                    <Text style={styles.textBox}>
                      Under Test Load At Bogie Shop {'\n'}
