import {
  ...
  const Lwlrrm2 = ({navigation,route}) => {
          ...
          <View style={{padding: 10}}>
            ...
            <View style={styles.boxstyle1}>
              ...
              <View
                ...
                <Text style={styles.text11}>LWLRRM(Gen. Van Side 2)</Text>
                <TextInput
                  style={styles.input}
            ...
            <View style={styles.boxstyle1}>
              ...
              <Text style={styles.text2}>MCF/RBL/QMF-5013</Text>
            </View>
            <View style={styles.boxstyle1}>
            ...
            <View style={{flexDirection: 'row'}}>
              <View style={{width: '50%', height: 350, padding: 5}}>
                ...
                <View style={{flex: 0.8}}>
                  <Text style={styles.textBox}>TARE 18.858</Text>
                </View>
                <View style={{flex: 0.8}}>
                  <Text style={styles.textBox}>GROSS 22.426</Text>
                </View>
              </View>
