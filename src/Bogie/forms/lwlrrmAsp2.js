...
import axios from 'axios';
  ...
  const LwlrrmAsp2 = ({navigation,route}) => {
            ...
            <View style={{padding: 10}}>
              ...
              <View style={styles.boxstyle1}>
                ...
                <View
                  ...
                  <Text style={styles.text11}>LWLRRM(Gen.van)(750X2)Side 2 Hand brake (AIR SPRING)</Text>
                  <TextInput
                    style={styles.input}
              ...
              <View style={styles.boxstyle1}>
                ...
                <Text style={styles.text2}>MCF/RBL/QMF-5022</Text>
              </View>
              <View style={styles.boxstyle1}>
