        ...
        <View>
          ...
          <View style={{padding: 10}}>
            ...
            <View style={styles.boxstyle1}>
              ...
              <View
                ...
                <Text style={styles.text11}>
                  LSLRD/US,LDSL rX1,LDS LR750x2 WITH AIR SPRING
                </Text>
                <TextInput
                  style={styles.input}
            ...
            <View style={styles.boxstyle1}>
              ...
              <Text style={styles.text2}>MCF/RBL/QMF-5020</Text>
            </View>
            <View style={styles.boxstyle1}>
              <Text style={styles.text2}>VERSION</Text>
              <Text style={styles.text2}>03/2019</Text>
            </View>
            <View style={styles.boxstyle1}>
            ...
            <View>
              ...
              <View style={styles.boxstyle1}>
                ...
                <Text style={styles.text2}>LW90033 Alt.-b,Anx-2</Text>
              </View>
              <View style={styles.boxstyle1}>
            ...
            <View style={styles.boxstyle3}>
              <View style={{flexDirection: 'row'}}>
                <View style={{width: '50%', height: 350, padding: 5}}>
                  ...
                  <View style={{flex: 1}}>
                    <Text style={styles.textBox}>TARE 17.81</Text>
                  </View>
                  <View style={{flex: 1}}>
                    <Text style={styles.textBox}>GROSS 22.11</Text>
                  </View>
                </View>
