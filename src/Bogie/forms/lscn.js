          ...
          <View style={{padding: 10}}>
            ...
            <View style={styles.boxstyle1}>
              ...
              <View
                ...
                <Text style={styles.text11}>LGS/LSCN</Text>
                <TextInput
                  style={styles.input}
            ...
            <View style={styles.boxstyle1}>
              ...
              <Text style={styles.text2}>MCF/RBL/QMF-5011</Text>
            </View>
            <View style={styles.boxstyle1}>
            ...
            <View style={{flexDirection: 'row'}}>
              <View style={{width: '50%', height: 350, padding: 5}}>
                ...
                <View style={{flex: 0.8}}>
                  <Text style={styles.textBox}>TARE 11.997</Text>
                </View>
                <View style={{flex: 0.8}}>
                  <Text style={styles.textBox}>GROSS 18.430</Text>
                </View>
              </View>
