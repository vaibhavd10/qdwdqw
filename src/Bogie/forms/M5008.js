...
async function assignRework (){
        ...
        <Image
          ...
          />
            ...
            <View style={styles.headerTag}>
                ...
                <Text style={styles.headerText}> Form No. : - MCF/RBL/QMF 5008</Text>
          ...
          <View style={styles.MainForm}>
            ...
            <View style={styles.MainFormEntry}>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>1 Primary & Secondary suspension spring color coding  </Text>
 ...
 <View style={styles.MainFormFirstEntery}>
              ...
              {/* Form Entry Ten Section End */}
               ...
               <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                19	Fitment of Rubber spring with Socket head         
                </Text>
