import {
  ...
  console.log(id,"ye route wali hai ")
            ...
            <View style={{padding: 10}}>
              ...
              <View style={styles.boxstyle1}>
                ...
                <View
                  ...
                  <Text style={styles.text11}>LSLRD/EOG WITH (AIR SPRING)</Text>
                  <TextInput
                    style={styles.input}
              ...
              <View style={styles.boxstyle1}>
                ...
                <Text style={styles.text2}>MCF/RBL/QMF-5018</Text>
              </View>
              <View style={styles.boxstyle1}>
                <Text style={styles.text2}>VERSION</Text>
                <Text style={styles.text2}>12/2018</Text>
              </View>
              <View style={styles.boxstyle1}>
              ...
              <View style={{flexDirection: 'row'}}>
                <View style={{width: '50%', height: 350, padding: 5}}>
                  ...
                  <View style={{flex: 0.8}}>
                    <Text style={styles.textBox}>TARE 17.915</Text>
                  </View>
                  <View style={{flex: 0.8}}>
                    <Text style={styles.textBox}>GROSS 22.08</Text>
                  </View>
                </View>
