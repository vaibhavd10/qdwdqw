        ...
        <View>
          ...
          <View style={{padding: 10}}>
            ...
            <View style={styles.boxstyle1}>
              ...
              <View
                ...
                <Text style={styles.text11}>
                  AC-3T/EOG WITH (120KN AIR SPRING)
                </Text>
                <TextInput
                  style={styles.input}
            ...
            <View style={styles.boxstyle1}>
              ...
              <Text style={styles.text2}>MCF/RBL/QMF-5026</Text>
            </View>
            <View style={styles.boxstyle1}>
              <Text style={styles.text2}>VERSION</Text>
              <Text style={styles.text2}>10/2020</Text>
            </View>
            <View style={styles.boxstyle1}>
            ...
            <View style={styles.boxstyle3}>
              <View style={{flexDirection: 'row'}}>
                <View style={{width: '50%', height: 350, padding: 5}}>
                  ...
                  <View style={{flex: 1}}>
                    <Text style={styles.textBox}>TARE 16.97</Text>
                  </View>
                  <View style={{flex: 1}}>
                    <Text style={styles.textBox}>GROSS 21.24</Text>
                  </View>
                </View>
            ...
            <View style={styles.boxstyle3}>
              <View style={{flexDirection: 'row'}}>
                <View style={{width: '50%', height: 457, padding: 5}}>
                  <View style={{flex: 4}}>
                    <Text style={styles.textBox}>
                      TESTING LOAD {'\n'}
                      IN TONNES
                ...
                <View style={{width: '50%', height: 457}}>
                  <View style={{flex: 3}}>
                    <Text style={styles.textBox}>
                      Under Test Load At Bogie Shop {'\n'}
