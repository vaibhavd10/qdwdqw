import {
  ...
  const QMF2011_LBAC_D = ({navigation}) => {
              ...
              <View style={styles.MainFormFirstEntery}>
                ...
                <View style={styles.FirstEntObserve}>
                  ...
                  <View style={styles.EntryObserveRadio}>
                    ...
                    <RadioButton
                      value="Ok"
                      status={checkedk130 === 'Ok' ? 'checked' : 'unchecked'}
                      onPress={() => setCheckedk130('Ok')}
                    />
                    <Text style={styles.FirstEntObserveRadio}>Not Provided</Text>
                    <RadioButton
                      value="Not Ok"
                      status={
                        checkedk130 === 'Not Ok' ? 'checked' : 'unchecked'
                      }
                      onPress={() => setCheckedk130('Not Ok')}
                    />
                  </View>
                </View>
                <View style={styles.FirstEntRemark}>
