...
import {
  ...
  const QMF2011_LSCZ_D = ({navigation}) => {
    ...
    return (
     ...
     {/* Form Entry Five Section Start */}
     <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>4. Final roof end condition</Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  5.Berth suspension bkt condition
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  6. Fan bkt location as per drg.(990 mm fan bkt dist.)
                </Text>
