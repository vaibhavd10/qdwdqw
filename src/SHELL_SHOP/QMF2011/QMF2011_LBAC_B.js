import {
  ...
  const QMF2011_LBAC_B = ({navigation}) => {
          ...
          <View style={styles.MainForm}>
            ...
            <View style={styles.MainFormEntry}>
             ...
             LBAC
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  15. Distance from under frame  to channel for water boiler
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  16. Distance from center line to channel for water boiler
                </Text>
