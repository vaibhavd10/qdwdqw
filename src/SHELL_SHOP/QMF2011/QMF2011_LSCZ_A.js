import {
  ...
  const QMF2011_LSCZ_A = ({navigation}) => {
        ...
        <View style={styles.Maincontainer}>
          ...
          <View style={styles.MainForm}>
            ...
            <View style={styles.MainFormEntry}>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  9. Chair mounting supporting channel distance from lateral center line
                </Text>
                <View style={styles.FiveEntryPart}>
                  <Text style={styles.FirstEntText}>PP side</Text>
                ...
                <View style={styles.FiveEntryPart}>
                  <Text style={styles.FirstEntText}>NPP side
</Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  10. Chair mounting supporting Channel between distance
                </Text>
  
                <View style={styles.FiveEntryPart}>
                  <Text style={styles.FirstEntText}>PP to NPP side</Text>
                  <View style={styles.SubObserve}>
                    <Text style={styles.SubObserveText}>
                      Observed value/condition
                    </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  11. Distance between bio tank brackets Holes.
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>12. Bio tank bracket between distance outer side for U/F center line (lateral) .</Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>13. Bio tank bracket between distance inner side for U/F center line (lateral)</Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  30. Switch box bracket hole (14 Ø,8 nos.) distance from hole center to center and diagonal should be equal
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  31 .Battery charger bracket hole (14 Ø,6 nos.) distance from hole center to center and diagonal should be equal
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  32. Both side Fiba bkt for air spring bogie
                </Text>
                ...
                <View style={styles.FirstEntObserve}>
                  ...
                  <View style={styles.EntryObserveRadio}>
                    ...
                    <RadioButton
                      value="Provided"
                      status={checkedk15 === 'Provided' ? 'checked' : 'unchecked'}
                      onPress={() => setCheckedk15('Provided')}
                    />
                    <Text style={styles.FirstEntObserveRadio}>NOT OK</Text>
                    <RadioButton
                      value="Not Provided"
                      status={checkedk15 === 'Not Provided' ? 'checked' : 'unchecked'}
                      onPress={() => setCheckedk15('Not Provided')}
                    />
                  </View>
                </View>
                <View style={styles.FirstEntRemark}>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  33. Reservoir tank bkt for air spring bogie
                </Text>
