import {
  ...
  const QMF2011_LBAC_A = ({navigation}) => {
          ...
          <View style={styles.MainForm}>
            ...
            <View style={styles.MainFormEntry}>
              ...
              <View style={styles.MainFormFirstEntery}>
                ...
                <View style={styles.FiveEntryPart}>
                  <Text style={styles.FirstEntText}>Lateral center line to pillar center line at (PP to NPP)</Text>
                ...
                <View style={styles.FiveEntryPart}>
                  <Text style={styles.FirstEntText}>Longitudinal center line to pillar center line at (PP to NPP)</Text>
