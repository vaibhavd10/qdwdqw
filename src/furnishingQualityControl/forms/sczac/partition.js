                    ...
                    <View style={styles.checkPoint}> 
                        ...
                        <View style={styles.checkPointSection}>
                            <View style={styles.checkPointSectionA}>
                                ...
                                <View style={styles.checkPointInput}>
                                    <Text style={styles.checkText}>Excess gap between ceiling & partition-</Text>
                                    <TextInput 
                                    style={styles.checkInputBox}
                                    onChangeText={setCheck1}
                                    value={check1}
                            ...
                            <View style={styles.checkPointSectionB}>
                                ...
                                <View style={styles.checkPointInput}>
                                    <Text style={styles.checkText}>Partition dirty-</Text>
                                    <TextInput 
                                    style={styles.checkInputBox}
                                    onChangeText={setCheck1}
                                    value={check1}
                                ...
                                <View style={styles.checkPointInput}>
                                    <Text style={styles.checkText}>Partition panel screw loose-</Text>
                                    <TextInput 
                                    style={styles.checkInputBox}
                                    onChangeText={setCheck1}
                                    value={check1}
                                ...
                                <View style={styles.checkPointInput}>
                                    <Text style={styles.checkText}>Excess gap in partition joint-</Text>
                                    <TextInput 
                                    style={styles.checkInputBox}
                                    onChangeText={setCheck1}
                                    value={check1}
                    ...
                    <View style={styles.checkPoint}> 
                        ...
                        <View style={styles.checkPointSection}>
                            ...
                            <View style={styles.checkPointSectionB}>
                                ...
                                <View style={styles.checkPointInput}>
                                    <Text style={styles.checkText}>Pillar cover not properly sited -</Text>
                                    <TextInput 
                                    style={styles.checkInputBox}
                                    onChangeText={setCheck1}
                                    value={check1}
