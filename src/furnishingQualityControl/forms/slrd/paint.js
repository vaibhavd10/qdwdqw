    ...
    <SafeAreaView style={styles.container}>
        ...
        <View style={styles.form}>
              {/* <View style={styles.formTag}>
                <Text style={styles.formTagText}>11-PAINT</Text>
              </View> */}
              {/* form entry */}
              ...
              <View style={styles.itemTag}>
                ...
                <Text style={styles.itemTagText}>DENTINATION BOARD</Text>
             </View>
              ...
              <View style={styles.itemTag}>
                <Text style={styles.itemTagText}>Item:-</Text>
                <Text style={styles.itemTagText}>Stencilling and Lattering</Text>
             </View>
                    ...
                    <View style={styles.checkPoint}> 
                        ...
                        <View style={styles.checkPointSection}>
                            <View style={styles.checkPointSectionA}>
                                ...
                                <View style={styles.checkPointInput}>
                                    <Text style={styles.checkText}>Check to proper scaling</Text>
                                    <TextInput 
                                    style={styles.checkInputBox}
                                    onChangeText={setCheck1}
                                    value={check1}
              ...
              <View style={styles.itemTag}>
                <Text style={styles.itemTagText}>Item:-</Text>
                <Text style={styles.itemTagText}>Braille Sticker</Text>
             </View>
                    ...
                    <View style={styles.checkPoint}> 
                        ...
                        <View style={styles.checkPointSection}>
                            <View style={styles.checkPointSectionA}>
                                ...
                                <View style={styles.checkPointInput}>
                                    <Text style={styles.checkText}>Burr in rivet</Text>
                                    <TextInput 
                                    style={styles.checkInputBox}
                                    onChangeText={setCheck1}
                                    value={check1}
                            ...
                            <View style={styles.checkPointSectionB}>
                                ...
                                <View style={styles.checkPointInput}>
                                    <Text style={styles.checkText}>Pasting is not proper in scale-</Text>
                                    <TextInput 
                                    style={styles.checkInputBox}
                                    onChangeText={setCheck1}
                                    value={check1}
              ...
              <View style={styles.itemTag}>
                <Text style={styles.itemTagText}>Item:-</Text>
                <Text style={styles.itemTagText}>Number Plate</Text>
             </View>
