    ...
    <SafeAreaView style={styles.container}>
        ...
        <View style={styles.form}>
              ...
              <View style={styles.itemTag}>
                ...
                <Text style={styles.itemTagText}>W/ level gauge-</Text>
             </View>
                        ...
                        <View style={styles.checkPointSection}>
                            <View style={styles.checkPointSectionA}>
                                ...
                                <View style={styles.checkPointInput}>
                                    <Text style={styles.checkText}>Reading -ok/not ok-</Text>
                                    <TextInput 
              ...
              <View style={styles.itemTag}>
                <Text style={styles.itemTagText}>Item:-</Text>
                <Text style={styles.itemTagText}>Tap-</Text>
             </View>
                    ...
                    <View style={styles.checkPoint}> 
                        ...
                        <View style={styles.checkPointSection}>
                            <View style={styles.checkPointSectionA}>
                                ...
                                <View style={styles.checkPointInput}>
                                    <Text style={styles.checkText}>I/s & o/s loose-</Text>
                                    <TextInput 
                                    style={styles.checkInputBox}
                                    onChangeText={setCheck1}
                                    value={check1}
              ...
              <View style={styles.itemTag}>
                <Text style={styles.itemTagText}>Item:-</Text>
                <Text style={styles.itemTagText}>Shower handle</Text>
             </View>
                    ...
                    <View style={styles.checkPoint}> 
                        ...
                        <View style={styles.checkPointSection}>
                            <View style={styles.checkPointSectionA}>
                                ...
                                <View style={styles.checkPointInput}>
                                    <Text style={styles.checkText}>Broken-</Text>
                                    <TextInput 
                                    style={styles.checkInputBox}
                                    onChangeText={setCheck1}
                                    value={check1}
                            ...
                            <View style={styles.checkPointSectionB}>
                                ...
                                <View style={styles.checkPointInput}>
                                    <Text style={styles.checkText}>Stand screw loose-</Text>
                                    <TextInput 
                                    style={styles.checkInputBox}
                                    onChangeText={setCheck1}
                                    value={check1}
