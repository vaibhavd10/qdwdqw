  ...
  return (
    ...
    <View style={styles.imageTag}>
        ...
        <View style={styles.form}>
                    ...
                    <View style={styles.checkPoint}> 
                        ...
                        <View style={styles.checkPointSection}>
                            <View style={styles.checkPointSectionA}>
                                ...
                                <View style={styles.checkPointInput}>
                                    <Text style={styles.checkText}>Roughly putty applied at B,No-</Text>
                                    <TextInput 
                                    style={styles.checkInputBox}
                            ...
                            <View style={styles.checkPointSectionB}>
                                ...
                                <View style={styles.checkPointInput}>
                                    <Text style={styles.checkText}>Pillar mounting hardware loose-</Text>
                                    <TextInput 
                                    style={styles.checkInputBox}
                    ...
                    <View style={styles.checkPoint}> 
                        ...
                        <View style={styles.checkPointSection}>
                            <View style={styles.checkPointSectionA}>
                                ...
                                <View style={styles.checkPointInput}>
                                    <Text style={styles.checkText}>Burr found at B.No-</Text>
                                    <TextInput 
                                    style={styles.checkInputBox}
                            ...
                            <View style={styles.checkPointSectionB}>
                                ...
                                <View style={styles.checkPointInput}>
                                    <Text style={styles.checkText}>Burr on berth holding bkt at B.No-</Text>
                                    <TextInput 
                                    style={styles.checkInputBox}
                    ...
                    <View style={styles.checkPoint}> 
                        ...
                        <View style={styles.checkPointSection}>
                            <View style={styles.checkPointSectionA}>
                                ...
                                <View style={styles.checkPointInput}>
                                    <Text style={styles.checkText}>Bottom extrusion short-</Text>
                                    <TextInput 
                                    style={styles.checkInputBox}
              ...
              <View style={styles.itemTag}>
                <Text style={styles.itemTagText}>Item:-</Text>
                <Text style={styles.itemTagText}>Plastic Film</Text>
             </View>
                    ...
                    <View style={styles.checkPoint}> 
                        ...
                        <View style={styles.checkPointSection}>
                            <View style={styles.checkPointSectionA}>
                                ...
                                <View style={styles.checkPointInput}>
                                    <Text style={styles.checkText}>Not removed from Partition-</Text>
                                    <TextInput 
                                    style={styles.checkInputBox}
