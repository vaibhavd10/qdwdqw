...
const Lavatory = ({navigation}) => {
    ...
    const[input94,setInput94]=useState('')
    const[input95,setInput95]=useState('')
    const[input96,setInput96]=useState('')
