...
const CoachLowering = ({navigation}) => {
    ...
    <SafeAreaView style={styles.container}>
        ...
        <View style={styles.form}>
              {/* <View style={styles.formTag}>
                <Text style={styles.formTagText}>10-COACH LOWERING</Text>
              </View> */}
              {/* form entry */}
              ...
              <View style={styles.itemTag}>
                ...
                <Text style={styles.itemTagText}>CBC eye pin</Text>
             </View>
