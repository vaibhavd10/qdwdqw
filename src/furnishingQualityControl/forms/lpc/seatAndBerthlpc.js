  ...
  return (
    ...
    <View style={styles.imageTag}>
        ...
        <View style={styles.form}>
                        ...
                        <View style={styles.checkPointSection}>
                            <View style={styles.checkPointSectionA}>
                                ...
                                <View style={styles.checkPointInput}>
                                    <Text style={styles.checkText}>Backrest mounting H/W loose-</Text>
                                    <TextInput 
              ...
              <View style={styles.itemTag}>
                <Text style={styles.itemTagText}>Item:-</Text>
                <Text style={styles.itemTagText}>Guard Table-</Text>
             </View>
                    ...
                    <View style={styles.checkPoint}> 
                        ...
                        <View style={styles.checkPointSection}>
                            <View style={styles.checkPointSectionA}>
                                ...
                                <View style={styles.checkPointInput}>
                                    <Text style={styles.checkText}> Not seated with its bkt-</Text>
                                    <TextInput 
                                    style={styles.checkInputBox}
                                    onChangeText={setCheck1}
                                    value={check1}
                    ...
                    <View style={styles.checkPoint}> 
                        ...
                        <View style={styles.checkPointSection}>
                            ...
                            <View style={styles.checkPointSectionB}>
                                ...
                                <View style={styles.checkPointInput}>
                                    <Text style={styles.checkText}>Latch catch miss- match-</Text>
                                    <TextInput 
                                    style={styles.checkInputBox}
                                    onChangeText={setCheck1}
                                    value={check1}
              ...
              <View style={styles.itemTag}>
                <Text style={styles.itemTagText}>Item:-</Text>
                <Text style={styles.itemTagText}>Luggage Rake</Text>
             </View>
                    ...
                    <View style={styles.checkPoint}> 
                        ...
                        <View style={styles.checkPointSection}>
                            ...
                            <View style={styles.checkPointSectionB}>
                                ...
                                <View style={styles.checkPointInput}>
                                    <Text style={styles.checkText}>Hardware short in length-</Text>
                                    <TextInput 
                                    style={styles.checkInputBox}
                                    onChangeText={setCheck1}
                                    value={check1}
