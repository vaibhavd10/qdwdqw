...
const MouldingAndDoor = ({navigation}) => {
    ...
    <View style={styles.imageTag}>
        ...
        <View style={styles.form}>
              ...
              <View style={styles.itemTag}>
                ...
                <Text style={styles.itemTagText}>Fitment Collapsible sliding door</Text>
             </View>
              ...
              <View style={styles.itemTag}>
                <Text style={styles.itemTagText}>Item:-</Text>
                <Text style={styles.itemTagText}>Fitment side wall panel</Text>
             </View>
              ...
              <View style={styles.itemTag}>
                <Text style={styles.itemTagText}>Item:-</Text>
                <Text style={styles.itemTagText}>Fitment sliding door  corner panel</Text>
             </View>
              ...
              <View style={styles.itemTag}>
                <Text style={styles.itemTagText}>Item:-</Text>
                <Text style={styles.itemTagText}>Fitment of SS Luggage Rack</Text>
             </View>
...
export default MouldingAndDoor
