...
const ProdWheel = ({navigation,route}) => {
...
//console.log("first")
 ...
 const bar=(id)=>{
  ...
  // console.log("hello")
    ...
    const firstpage =() =>{
        navigation.navigate('Wheel Prod Job')
    };
    const mcf =()=>{
  ...
  return (
    <SafeAreaView>
        ...
        <TouchableOpacity
          ...
          onPress={firstpage}
          >
          <Text style={{color: 'white'}}>Create New Job</Text>
        </TouchableOpacity>
        {/* <TouchableOpacity
          style={styles.button1}
          onPress={mcf}
          >
          <Text style={{color: 'white'}}>Mcf</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.button1}
          onPress={rites}
          >
          <Text style={{color: 'white'}}>rites</Text>
        </TouchableOpacity>
         */}
           {/* <TouchableOpacity
          style={styles.button1}
